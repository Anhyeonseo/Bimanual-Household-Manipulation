...
CONFIRMATION = "F7_BIMANUAL_CURRENT_POSE_HOLD_ONCE"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=root / "artifacts/f7/2026-08-14/current_pose_hold_run01.json",
    )
...
def main() -> int:
    ...
    try:
        ...
        document = {
            "schema_version": 1,
            "record_kind": "f7_bimanual_current_pose_hold_once",
            "overall_verdict": "F7_BIMANUAL_CURRENT_POSE_HOLD_ONCE_PASS",
        ...
        print(
            "F7_BIMANUAL_CURRENT_POSE_HOLD_ONCE_PASS "
