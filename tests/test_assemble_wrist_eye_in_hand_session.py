...
class AssembleWristEyeInHandSessionTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_assembles_fail_closed_session_with_relative_images(self):
        ...
        self.assertEqual(document["frames"]["camera"], "left_wrist_camera_optical_frame")
        self.assertEqual(document["frames"]["gripper"], "left_gripper_frame_link")
        self.assertEqual(document["target"]["first_marker_id"], 10)
