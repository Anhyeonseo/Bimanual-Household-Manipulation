...
ARTIFACT_SHA256 = (
    "439bda79557c3697194d85c1e41c196448a5b15c7a9380f8696e700d69c33575"
)
...
def test_plan_is_non_executable_and_pins_collision_checked_source():
    ...
    assert document["firmware_version"] == "0x00022F00"
    assert document["firmware_deployment_gate"] == {
        "candidate_status": "LOCAL_JOINT_LIMIT_MARGIN_DEPLOYED",
        "deployed": True,
