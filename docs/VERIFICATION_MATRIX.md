...
| VIS-003 | 단계 8 | 시연 환경 강건 펜 검출 | 카메라 각도·높이·물체 Z 고정, 배경·조명·반사만 다른 조건에서 물체 1개와 위치/yaw·miss·false positive 기준 충족 | 부분 통과 | [기준선 계약](test-results/2026-08-02-top-pen-detection-baseline-contract.md), [holdout·legacy 결과](test-results/2026-08-02-top-pen-holdout-legacy-baseline.md). 고정 holdout 18장 수집·승인 완료. Legacy는 miss 100%, false positive 66.7%로 예상 실패했으며 경량 YOLO-OBB/ONNX 비교와 시연 환경 재검증이 남음 |
