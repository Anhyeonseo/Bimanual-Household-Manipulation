...
| MOT-003 | 단계 8 | 왼팔 multi-point/buffered trajectory | 시간축·queue·cancel·soft-abort·SAFE_STOP 실기 통과, 불필요한 정착 정지 제거 | 부분 통과 | [Motion-1](checklists/MOTION_BUFFERED_TRAJECTORY_CONTRACT.md), [Motion-2](checklists/MOTION_STM32_BUFFERED_QUEUE.md), [Motion-3](checklists/MOTION_BUFFERED_COMMAND_ROUTE_TIMING.md), [Motion-4](checklists/MOTION_G474_BUFFERED_VALIDATION_ROUTE.md), [Motion-5](checklists/MOTION_BUFFERED_HOST_ADAPTER.md), [Motion-6](checklists/MOTION_BUFFERED_STATUS_MAPPING.md), [Motion-7](checklists/MOTION_BUFFERED_MOCK_TRANSPORT.md), [Motion-8](checklists/MOTION_G474_BUFFERED_PHYSICAL_ROUTE.md). `0x00022000` physical route, one-shot host exchange, C fault test와 cross-build까지 통과했다. Pi 배포·ROS Action·제한 실기는 미실행 |
