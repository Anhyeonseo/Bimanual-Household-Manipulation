...
| T4 | 300 mm task contract, 물성 증빙과 episode 단위 데이터 분리 | 리뷰+자동 | 개발 595/검수 103 + 물리 재배치 held-out 38/검수 35·robot OOD 3, split leakage 0; 질량 56.7 g·4겹 두께 18.26/18.1 mm·작업대 유효 마찰 0.701/0.737·100.1 mm edge-release 평균 0.181 s·45° overhang 평균 36.33 mm 실측 완료 |
...
| T8b | Isaac Lab S0–S3와 scripted/learned baseline | 자동+Isaac+오프라인 | S0 PASS. Coupled VBD actual-contact gate와 실측 hold-until-Q0-open retention을 사용한 중력+표면 드래그 1차 접기 3회 PASS: 최대 layer `51.609/48.391`, p95 `16.398 mm`, 높이 `26.488 mm`, 폭 `156.332 mm`, terminal Z/curl 0. R2 `75%`; 반복 성공률·2차 접기·S2/S3 남음 |
...
| Isaac S0/S1 | S0는 FOV·접근·충돌만 주장하고, S1은 실제 jaw 접촉으로 활성화한 retention·lift·표면 드래그·laydown·Q0 release·termination을 seed별로 재생함 |
